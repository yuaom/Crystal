...
namespace Crystal
{
    ...
    ////////////////////////////////////////////////////////////////////////////////
    std::unique_ptr<Displays>   Displays::m_pDisplays = nullptr;

    ////////////////////////////////////////////////////////////////////////////////
    void Displays::OnDllProcessAttach()
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void Displays::OnDllProcessDetach()
    {
        m_pDisplays.release();
    }

    ////////////////////////////////////////////////////////////////////////////////
    std::unique_ptr<Displays>& Displays::get()
    {
        return m_pDisplays;
    }
