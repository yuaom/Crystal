...
#pragma region D3DWDDM1_3DDI_DEVICEFUNCS
namespace Crystal
{
namespace UMD
{
...
VOID WINAPI UpdateTileMappings( D3D10DDI_HDEVICE, D3D10DDI_HRESOURCE, UINT, const D3DWDDM1_3DDI_TILED_RESOURCE_COORDINATE*, const D3DWDDM1_3DDI_TILE_REGION_SIZE*, D3D10DDI_HRESOURCE, UINT, const UINT*, const UINT*, const UINT*, UINT );
VOID WINAPI UpdateTiles( D3D10DDI_HDEVICE, D3D10DDI_HRESOURCE, const D3DWDDM1_3DDI_TILED_RESOURCE_COORDINATE*, const D3DWDDM1_3DDI_TILE_REGION_SIZE*, const void*, UINT );
...
VOID WINAPI CheckMultisampleQualityLevels( D3D10DDI_HDEVICE, DXGI_FORMAT, UINT, UINT, UINT* );
BOOL WINAPI Flush( D3D10DDI_HDEVICE, UINT );
VOID WINAPI GetMipPacking( D3D10DDI_HDEVICE, D3D10DDI_HRESOURCE, UINT*, UINT* );
VOID WINAPI RelocateDeviceFuncs( D3D10DDI_HDEVICE, struct D3DWDDM1_3DDI_DEVICEFUNCS* );
...
VOID WINAPI SetMarker( D3D10DDI_HDEVICE );
VOID WINAPI SetMarkerMode( D3D10DDI_HDEVICE, D3DWDDM1_3DDI_MARKER_TYPE, UINT );
...
VOID WINAPI CopyTileMappings( D3D10DDI_HDEVICE, D3D10DDI_HRESOURCE, const D3DWDDM1_3DDI_TILED_RESOURCE_COORDINATE*, D3D10DDI_HRESOURCE, const D3DWDDM1_3DDI_TILED_RESOURCE_COORDINATE*, const D3DWDDM1_3DDI_TILE_REGION_SIZE*, UINT );
VOID WINAPI CopyTiles( D3D10DDI_HDEVICE, D3D10DDI_HRESOURCE, const D3DWDDM1_3DDI_TILED_RESOURCE_COORDINATE*, const D3DWDDM1_3DDI_TILE_REGION_SIZE*, D3D10DDI_HRESOURCE, UINT64, UINT );
...
VOID WINAPI ResizeTilePool( D3D10DDI_HDEVICE, D3D10DDI_HRESOURCE, UINT64 );
VOID WINAPI TiledResourceBarrier( D3D10DDI_HDEVICE, D3D11DDI_HANDLETYPE, void*, D3D11DDI_HANDLETYPE, void* );
#pragma endregion
...
#pragma region DXGI1_6_1_DDI_BASE_FUNCTIONS
namespace Crystal
{
namespace UMD
{
...
#pragma region DDI Entry-points
HRESULT WINAPI CheckPresentDurationSupport( DXGI_DDI_ARG_CHECKPRESENTDURATIONSUPPORT* );
HRESULT WINAPI Present( DXGI_DDI_ARG_PRESENT* );
HRESULT WINAPI Present1( DXGI1_6_1_DDI_ARG_PRESENT* );
HRESULT WINAPI PresentMultiplaneOverlay( DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY* );
HRESULT WINAPI PresentMultiplaneOverlay1( DXGI1_6_1_DDI_ARG_PRESENTMULTIPLANEOVERLAY* );
HRESULT WINAPI SetDisplayMode( DXGI_DDI_ARG_SETDISPLAYMODE* );
HRESULT WINAPI CheckMultiplaneOverlayColorSpaceSupport( DXGI_DDI_ARG_CHECKMULTIPLANEOVERLAYCOLORSPACESUPPORT* );
HRESULT WINAPI GetGammaCaps( DXGI_DDI_ARG_GET_GAMMA_CONTROL_CAPS* );
HRESULT WINAPI GetMultiplaneOverlayCaps( DXGI_DDI_ARG_GETMULTIPLANEOVERLAYCAPS* );
HRESULT WINAPI GetMultiplaneOverlayGroupCaps( DXGI_DDI_ARG_GETMULTIPLANEOVERLAYGROUPCAPS* );
HRESULT WINAPI OfferResources1( DXGI_DDI_ARG_OFFERRESOURCES1* );
HRESULT WINAPI QueryResourceResidency( DXGI_DDI_ARG_QUERYRESOURCERESIDENCY* );
HRESULT WINAPI ReclaimResources( DXGI_DDI_ARG_RECLAIMRESOURCES* );
HRESULT WINAPI ReclaimResources1( DXGI_DDI_ARG_RECLAIMRESOURCES1* );
HRESULT WINAPI ResolveSharedResource( DXGI_DDI_ARG_RESOLVESHAREDRESOURCE* );
HRESULT WINAPI RotateResourceIdentities( DXGI_DDI_ARG_ROTATE_RESOURCE_IDENTITIES* );
HRESULT WINAPI SetResourcePriority( DXGI_DDI_ARG_SETRESOURCEPRIORITY* );
HRESULT WINAPI TrimResidencySet( DXGI_DDI_ARG_TRIMRESIDENCYSET* );
HRESULT WINAPI Blt( DXGI_DDI_ARG_BLT* );
HRESULT WINAPI Blt1( DXGI_DDI_ARG_BLT1* );
#pragma endregion
